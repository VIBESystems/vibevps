  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-surface-100">Aggiornamenti</h1>
          <p className="text-surface-400">Controlla aggiornamenti e gestisci la tua licenza</p>
        </div>
        <button
          onClick={loadData}
          className="flex items-center gap-2 px-4 py-2 text-surface-300 hover:bg-surface-800 rounded-lg transition"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-surface-900 border border-surface-700 rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-4 bg-surface-800 rounded-lg">
              <div>
              ...
              <div className="flex items-center gap-2 px-3 py-1 bg-emerald-500/15 text-emerald-400 rounded-full text-sm">
                ...
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-1.5 text-sm text-primary-400 hover:bg-primary-500/10 rounded-lg disabled:opacity-50 transition"
                    >
