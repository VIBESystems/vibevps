              ...
              <CardContent className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-surface-500">{hv.type} - {hv.host}:{hv.port}</p>
                  </div>
                  {testResults[hv.id] === true && <CheckCircle2 className="w-5 h-5 text-green-400" />}
                  {testResults[hv.id] === false && <XCircle className="w-5 h-5 text-red-400" />}
                </div>
