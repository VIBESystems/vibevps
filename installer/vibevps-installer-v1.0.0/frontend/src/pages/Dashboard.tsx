  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-surface-100">Dashboard</h2>
      ...
      {Object.entries(nodeStatuses).length > 0 && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {filteredHypervisors.map((hv) => {
            ...
            return (
              <div key={hv.id} className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:col-span-2">
                {/* Node Status Card */}
                <Card>
                  <CardHeader>
                    <div className="flex items-center justify-between">
              ...
              <div className="divide-y divide-surface-700">
                {filteredVMs.slice(0, 8).map((vm) => (
                  <Link
                    ...
                    className="flex items-center justify-between px-7 py-4 hover:bg-surface-700/50 transition-colors"
                  >
                    <div className="flex items-center gap-3">
        ...
        <Card>
          ...
          <CardContent className="p-0">
            {logs.length === 0 ? (
              ...
              <div className="divide-y divide-surface-700">
                {logs.map((log) => (
                  <div key={log.id} className="px-7 py-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
